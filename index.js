...
bot.command('play', async ctx => {
	await ctx.deleteMessage();
	return ctx.reply('Выберите режим игры - сколько символов хотите отгадывать?', Markup.inlineKeyboard([[Markup.button.callback('3', 'play3'), Markup.button.callback('4', 'play4'), Markup.button.callback('5', 'play5'), Markup.button.callback('6', 'play6')]]));
});
